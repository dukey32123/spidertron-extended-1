...
repair_beam.head = {
    filename = "__spidertron-extended-dukey-edition__/graphics/spidertron_builder_laser_body_HD_1.png",
...
repair_beam.tail = {
    filename = "__spidertron-extended-dukey-edition__/graphics/spidertron_builder_laser_end_HD_1.png",
    tint = {r = 0.8, g = 0.8, b = 0.8},
...
data:extend{
    {
        type = "ammo",
        name = "retrofitted-battery",
        icon = "__spidertron-extended-dukey-edition__/graphics/spidertron_builder_energy_cell_repair_1.png",
        icon_size = 64,
        flags = {"hidden"},
        ammo_type = {
    ...
    },
    {
        type = "ammo",
        name = "retrofitted-battery2",
        icon = "__spidertron-extended-dukey-edition__/graphics/spidertron_builder_energy_cell_repair_3.png",
        icon_size = 64,
        flags = {"hidden"},
        ammo_type = {
