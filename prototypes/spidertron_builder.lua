...
spidertron_builder_entity.minimap_representation = {
    filename = "__spidertron-extended-dukey-edition__/icons/spidertron_extended_builder_map.png",
    flags = {"icon"},
    size = {128, 128},
    scale = 0.5
}
...
spidertron_builder_entity.graphics_set.animation.layers[3] = {
	filename = "__spidertron-extended-dukey-edition__/graphics/spidertron_builder_eye.png",
	width = 66,
	height = 70,
	line_length = 8,
	direction_count = 64,
	...
	hr_version = {
		filename = "__spidertron-extended-dukey-edition__/graphics/spidertron_builder_eye_HD.png",
		width = 132,
		height = 138,
		line_length = 8,
		direction_count = 64,
...
spidertron_builder_entity.graphics_set.animation.layers[4] = {
	filename = "__spidertron-extended-dukey-edition__/graphics/spidertron_builder_laser_turret_overlay.png",
	width = 132,
	height = 138,
	line_length = 8,
	direction_count = 64,
